 ...
 * Google sign in button for application login.
...
public class LoginActivity extends AppCompatActivity {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == RC_SIGN_IN) {
            ...
            //passing task to handleSignInResult - going to get the result and see if the
            //user is actually signed in - if not will catch exception and display failed
